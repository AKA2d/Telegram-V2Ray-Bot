...
JOIN_CHANNEL_PROMPT = "برای اطلاع از اخبار تخفیفات و ... داخل چنل اصلیمون عضو بشید"
...
CHOOSE_SERVICE_TYPE = "نوع سرویس مورد نظر خود را انتخاب کنید:"
BTN_UNLIMITED_SERVICES = "♾️ سرویس‌های نامحدود"
BTN_TRAFFIC_SERVICES = "📊 سرویس‌های ترافیکی"
...
SERVICE_ACTIVATED_DETAILED = (
    ...
    "و انتخاب سیستم عامل خود دریافت کنید"
)
...
RECEIPT_RECEIVED = "رسید شما دریافت شد و برای بررسی به ادمین ارسال گردید. رسید شما حداکثر تا ۱۰ دقیقه آینده تایید خواهد شد."
...
CONNECT_PLATFORM_WINDOWS = "💻 ویندوز"
