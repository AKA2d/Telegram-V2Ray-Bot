...
ASK_ASSIGN_WHOLESALER_ID = "شناسه عددی تلگرام عمده‌فروش را ارسال کنید تا پلنی به او اختصاص یابد:"
ASK_UNASSIGN_WHOLESALER_ID = "شناسه عددی تلگرام عمده‌فروش را ارسال کنید تا تخصیص پلن را حذف کنیم:"
WHOLESALE_PLAN_ASSIGNED = "پلن با موفقیت به عمده‌فروش اختصاص یافت."
WHOLESALE_PLAN_UNASSIGNED = "تخصیص پلن حذف شد."
NO_WHOLESALE_PLANS_ASSIGNED = "هیچ پلن عمده‌فروشی به این عمده‌فروش اختصاص ندارد."
NO_WHOLESALE_PLANS_AVAILABLE = "در حال حاضر هیچ پلن عمده‌فروشی فعالی برای شما تعریف نشده است."
ASSIGN_PLAN_PROMPT = "پلنی را که می‌خواهید به این عمده‌فروش اختصاص پیدا کند انتخاب کنید:"
UNASSIGN_PLAN_PROMPT = "پلنی را که می‌خواهید از این عمده‌فروش حذف شود انتخاب کنید:"
WHOLESALE_PLAN_TOGGLED = "وضعیت پلن عمده‌فروشی تغییر کرد."
WHOLESALE_PLAN_REMOVED = "پلن عمده‌فروشی حذف شد."

ASK_WHOLESALE_PLAN_NAME = "نام پلن عمده‌فروشی را وارد کنید (مثلاً «۵ کاربر - ۱ ماهه»):"
ASK_WHOLESALE_PLAN_USER_COUNT = "تعداد کاربر این پلن عمده‌فروشی را وارد کنید (عدد):"
ASK_WHOLESALE_PLAN_MONTHS = "مدت این پلن عمده‌فروشی را به ماه وارد کنید (عدد):"
ASK_WHOLESALE_PLAN_TRAFFIC = "ترافیک این پلن عمده‌فروشی را به گیگابایت وارد کنید (عدد):"
ASK_WHOLESALE_PLAN_PRICE = "قیمت این پلن عمده‌فروشی را به تومان وارد کنید (عدد):"
WHOLESALE_PLAN_ADDED = "پلن عمده‌فروشی با موفقیت اضافه شد."
NO_WHOLESALE_PLANS_DEFINED = "هیچ پلن عمده‌فروشی تعریف نشده است."
WHOLESALE_PLANS_LIST_HEADER = "پلن‌های عمده‌فروشی تعریف‌شده:"
