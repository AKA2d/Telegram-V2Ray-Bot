...
from . import broadcast, cards, customers, direct_message, guide_mgmt, orders, plans, test_mgmt, tunnel, wallet_override, wholesalers

router = Router(name="admin")
router.include_router(test_mgmt.router)
router.include_router(guide_mgmt.router)
